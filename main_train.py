...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='/kaggle/input/iuxray/data/iu_xray/images', help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='/kaggle/input/iuxray/data/iu_xray/annotation.json', help='the path to the directory containing the data.')
    ...
    parser.add_argument('--early_stop', type=int, default=50, help='the patience of training.') # stooop
